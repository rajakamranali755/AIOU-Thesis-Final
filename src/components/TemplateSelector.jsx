  ...
  return (
    <div>
      ...
      <div className="mt-5 p-3 bg-white border border-slate-200 rounded-xl text-xs text-slate-9000 space-y-1">
        ...
        <p>All templates follow the AIOU thesis format (Appendix-F General Instructions): left margin 3.8cm, right and bottom 2.5cm, top 3.2cm, Times New Roman 12pt, double line spacing.</p>
