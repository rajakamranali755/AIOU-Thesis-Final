...
const ITEMS = [
  "Allama Iqbal Open University", "AIOU PhD Template", "AIOU MS (Computer Sciences)",
  "AIOU PhD Mass Communication", "AIOU Urdu (RTL)", "APA 7th", "MLA 9th", "Chicago", "IEEE",
];
  ...
  return (
    <section className="border-y border-border bg-background/30 backdrop-blur-sm py-8">
      <p className="mb-6 text-center text-xs font-bold uppercase tracking-widest text-muted-foreground">
        Built around the Allama Iqbal Open University thesis format
      </p>
