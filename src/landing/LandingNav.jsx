    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-3 sm:px-8">
        <a href="#top" className="flex items-center gap-2.5">
          <img src="/aiou-logo.png" alt="Allama Iqbal Open University" className="h-9 w-9 shrink-0" />
          <span className="text-sm font-extrabold tracking-tight text-foreground">AIOU Thesis Writing Suite</span>
        </a>
