...
import {
  Layers, ScanText, Library, Languages, FileDown, Image,
} from "lucide-react";
        ...
        <SpotlightCard className="md:col-span-2 md:row-span-2 flex flex-col justify-between">
          <div>
            ...
            <p className="mt-3 max-w-md text-muted-foreground">
              The AIOU thesis format and its programme variants, with APA 7th,
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            {["AIOU", "APA 7", "MLA 9", "Chicago", "IEEE", "Urdu RTL"].map((t) => (
