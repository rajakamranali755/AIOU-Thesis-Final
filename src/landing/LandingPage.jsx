      ...
      <footer className="border-t border-border bg-background/50 backdrop-blur-sm">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-5 py-8 sm:flex-row sm:px-8">
          <div className="flex items-center gap-2.5">
            <img src="/aiou-logo.png" alt="Allama Iqbal Open University" className="h-8 w-8 shrink-0" />
            <span className="text-sm font-bold text-foreground">AIOU Thesis Writing Suite</span>
          </div>
          <p className="text-xs text-muted-foreground">
            Thesis &amp; article builder · References · Research search
          </p>
