      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-5 sm:px-8 lg:grid-cols-2 lg:gap-6">
        ...
        <div className="text-center lg:text-left">
          ...
          >
            ...
            AIOU · APA · MLA · Chicago · IEEE — built for AIOU scholars
          </motion.div>
          ...
          >
            A complete AIOU thesis writing suite — format-perfect AIOU templates,
            citation styles with real source links, AI &amp; plagiarism scoring,
            and a thesis search engine.
          </motion.p>
